...
s1 = Showtime.new(empty_seats: 15, price_cents: 4, start_hour: DateTime.new(2019,12,06,20,37,48))

s1.movie = m1
s1.theater = t1
s1.save

s2 = Showtime.new(empty_seats: 25, price_cents: 3, start_hour: DateTime.new(2019,12,06,20,37,48))
s2.movie = m1
s2.theater = t1
s2.save

s3 = Showtime.new(empty_seats: 17, price_cents: 4, start_hour: DateTime.new(2019,12,06,20,37,48))
s3.movie = m2
s3.theater = t1
s3.save

s4 = Showtime.new(empty_seats: 37, price_cents: 3, start_hour: DateTime.new(2019,12,06,20,37,48))
s4.movie = m2
s4.theater = t1
s4.save

s5 = Showtime.new(empty_seats: 25, price_cents: 3)
s5.movie = m4
s5.theater = t1
s5.save

s6 = Showtime.new(empty_seats: 25, price_cents: 3)
s6.movie = m3
s6.theater = t1
s6.save
