...
hors_normes_1 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574769804/Peq7qpj2jnSUfHBVL1wTiyLF.jpg")
m1.photos.attach(io: hors_normes_1, filename: 'hors_normes-1.jpg', content_type: 'image/jpg')
hors_normes_2 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574768528/k7e3xntpf3jpkbdr2wev.jpg")
m1.photos.attach(io: hors_normes_2, filename: 'hors_normes-2.jpg', content_type: 'image/jpg')
hors_normes_3 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574766649/eiizplijmkcsb2qbixeo.jpg")
...
les_miserables_1 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574769808/2eah8TSSP7E9Vtt9oVCbdPwZ.jpg")
m2.photos.attach(io: les_miserables_1, filename: 'les_miserables-1.jpg', content_type: 'image/jpg')
les_miserables_2 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574769806/k7f84JmviBRVAvPtP6kLU7SQ.jpg")
m2.photos.attach(io: les_miserables_2, filename: 'les_miserables-2.jpg', content_type: 'image/jpg')
les_miserables_3 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574769805/s9Qo345ksNvQEMcVuEMEDMDZ.jpg")
...
roi_lion_1 = HTTParty.get("https://res.cloudinary.com/ddlesqeup/image/upload/v1574860505/images_pe8e7l.jpg")
